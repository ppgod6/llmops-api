...
class ConversationService(BaseService):
    ...
    def summary(cls, human_message: str, ai_message: str, old_summary: str = "") -> str:
        ...
        llm = ChatDeepSeek(model="deepseek-chat", api_key=os.getenv("OPENAI_API_KEY"), temperature=0.5)
    ...
    def generate_conversation_name(cls, query: str) -> str:
        ...
        # 2.构建大语言模型实例，并且将大语言模型的温度调低，降低幻觉的概率
        llm = ChatDeepSeek(model="deepseek-chat", api_key=os.getenv("OPENAI_API_KEY"), temperature=0)
